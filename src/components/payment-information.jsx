      ...
      <div className="flex justify-between mt-5">
        <div className="flex gap-2">
          ...
          <div className="space-y-3">
            <p className="text-lg font-medium text-zinc-700">Entrada no pix</p>
            <p className="text-lg font-medium text-zinc-700">Restante no cartão</p>
          </div>
        </div>

        <div className="space-y-5">
          <p className="font-extrabold text-zinc-700">R$ {formatNumberForString(values.installmentValue || 0)}</p>
